...
function Kuliner() {
  return (
    <div>
    <Navbar/>
    <img className="h-2/5 w-5/5 pt-20 bg-green-500" src={Gambarnfk} alt="image description"></img>
    <br/>
...
<form>
    <div className="relative flex-shrink-0 z-10 inline-flex items-center">
        ...
        <div id="dropdown" className="z-10 hidden bg-[#F1F1E8] divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
