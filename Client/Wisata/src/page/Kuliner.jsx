...
function Kuliner() {
  return (
    ...
    <br/>
    <h2 className="font-bold bg-[#F1F1E8] text-[#29446F] font-['Boogaloo'] text-[25px] pl-20 pb-5 tracking-[.1em]">Kuliner</h2>
    {/* Card */}

    {/* Card pennutup */}

  <div className="flex items-center justify-between w-full sm:w-96 bg-[#F1F1E8]">
...
<form>
    <div className="relative flex-shrink-0 z-10 inline-flex items-center bg-[#F1F1E8]">
