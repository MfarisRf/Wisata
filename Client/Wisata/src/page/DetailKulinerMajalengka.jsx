      ...
      <div className="grid grid-cols-2 gap-8">
        <div> 
            <figure class="max-w-lg">
              <img class="mt-14 min-w-full ml-20 mb-14 rounded-lg" src={GambarLotek} alt="image description"></img>
              <figcaption class="mt-2 text-5xl ml-20 mb-14 text-left text-[#29446F]-500 dark:text-[#29446F]-400">Lotek</figcaption>
              <p class="ml-20 text-[#29446F]-700 text-left">Lotek merupakan salah satu makanan khas di Kota Majalengka, Jawa Barat. Makanan ini sangat digemari oleh warga lokal maupun wisatawan yang datang dari luar kota. Lotek adalah sajian yang terbuat dari sayur-mayur segar, seperti kacang panjang, tauge, kentang, dan daun singkong. Sayuran-sayuran tersebut disiram dengan sambal kacang yang khas, memberikan cita rasa gurih dan pedas. Lontong sering menjadi pendamping dalam menyantap lotek. Lotek memiliki nilai gizi yang baik karena mengandung banyak serat dan vitamin dari sayuran, rasanya yang unik dan segar menjadikan lotek sebagai hidangan yang cocok untuk dinikmati di cuaca tropis. Jadi, jika Anda berkunjung ke Kota Majalengka, jangan lupa mencicipi lotek yang lezat ini. 
</p>
            </figure>
        </div>
      <div class="p-12">
    <div class="container mx-auto bg-[#E6E6E6] p-6 rounded-lg shadow-md text-center border-2 border-[#22B57F]">
        <h1 class="text-2xl font-bold mb-4">Rekomendasi Lotek Majalengka</h1>
        <div class="bg-[#BFDCAE] p-4 mt-4 rounded-lg shadow-md">
            <h2 class="text-lg font-bold mb-2 text-left">Lotek Ceu Enok</h2>
            <div class="bg-[#E6E6E6] p-4 mt-4 rounded-lg shadow-md">
                <h3 class="text-lg mb-2 text-left">Alamat : Jl. Siti Armilah No.47, Majalengka Kulon, Kab. Majalengka. </h3>
                <h3 class="text-lg mb-2 text-left">Jam Buka : Setiap hari pukul  10.00 - 15.00 WIB</h3>
                <h3 class="text-lg mb-2 text-left">Harga : Mulai dari Rp. 15.000 - 20.000</h3>
            </div>
        </div>
        <div class="bg-[#BFDCAE] p-4 mt-4 rounded-lg shadow-md">
            <h2 class="text-lg font-bold mb-2 text-left">Lotek Ema</h2>
            <div class="bg-[#E6E6E6] p-4 mt-4 rounded-lg shadow-md">
                <h3 class="text-lg mb-2 text-left">Alamat : Jl. Pemuda, Majalengka Kulon, Kec. Majalengka, Majalengka. </h3>
                <h3 class="text-lg mb-2 text-left">Jam Buka : Setiap hari pukul  06.00 - 17.00 WIB</h3>
                <h3 class="text-lg mb-2 text-left">Harga : Mulai dari Rp. 15.000</h3>
            </div>
        </div>
        ...
        <div class="bg-[#BFDCAE] p-4 mt-4 rounded-lg shadow-md">
            ...
            <div class="bg-[#E6E6E6] p-4 mt-4 rounded-lg shadow-md">
                <h3 class="text-lg mb-2 text-left">Alamat : Jl. Mutiara No.34, Rajagaluh Lor, Kec. Rajagaluh, Majalengka</h3>
                <h3 class="text-lg mb-2 text-left">Jam Buka : Setiap hari pukul  09.00 - 14.15 WIB</h3>
                <h3 class="text-lg mb-2 text-left">Harga : Mulai dari Rp. 15.000</h3>
            </div>
