      ...
      <div className="grid grid-cols-2 gap-8">
        <div> 
            <figure className="max-w-lg">
              ...
              <figcaption className="mt-2 text-5xl ml-20 mb-14 text-left text-[#29446F]-500 dark:text-[#29446F]-400">Telaga Biru Cirerem</figcaption>
              <p className="ml-20 text-[#29446F]-700 text-left">Telaga Biru Cirerem, sebuah surga tersembunyi, memukau pengunjung dengan keindahan alam yang luar biasa. Airnya yang begitu bening memberikan pandangan jernih ke dasar telaga, sementara sekelilingnya dihiasi oleh gemerlap hijau pepohonan yang menjadikan tempat ini seperti lukisan alam yang hidup. Pesona utama Telaga Biru Cirerem terletak pada perpaduan ajaib antara warna airnya yang bergradasi, menampilkan spektrum yang memikat antara biru dan hijau tosca. Keunikan ini menciptakan suasana yang begitu menawan dan memikat hati setiap pengunjungnya. </p>
            </figure>
        </div>
      <div className="p-12">
    <div className="container mx-auto bg-[#E6E6E6] p-6 rounded-lg shadow-md text-center border-2 border-[#22B57F]">
        <h1 className="text-2xl font-bold mb-4">Telaga Biru Cirerem</h1>
        <p className="text-gray-700 text-left">Alamat : Kaduela, Kec. Pasawahan, Kabupaten Kuningan, Jawa Barat</p>
        ...
        <div className="bg-[#BFDCAE] p-4 mt-4 rounded-lg shadow-md">
            ...
            <div className="bg-[#E6E6E6] p-4 mt-4 rounded-lg shadow-md">
                <h3 className="text-lg mb-2 text-left">Rp. 15.000</h3>
            </div>
