        ...
        <div>
            ...
            <div className="flex items-center gap-6 justify-center">
                <div className="w1/" style={{backgroundImage: `url(${background2}) `}}>
                  <p className="font-Lato text-29446F px-96 pl-56 mr-20 w-full h-72 p-14 font-['Lato'] " style={{backgroundImage: `url(${background0}) `}}>
                  <h3 className=" flex card text-2x1 text-Libre Baskerville sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900 font-['Baskerville']">MISI</h3>
