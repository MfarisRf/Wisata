...
function Oleholeh() {
  return (
    ...
    <Navbar/>
    <img className="h-2/5 w-5/5 pt-20" src={Gambarnfo} alt="image description"></img>
    <br/>
  ...
  <input type="search" id="search-dropdown" className="bg-[#F1F1E8] block p-2.5 w-72 z-20 text-sm text-gray-900 rounded-lg border-s-[#2D8C14] border-s-1 border border-[#2D8C14] focus:ring-[#2D8C14] focus:border-[#2D8C14] dark:bg-gray-700 dark:border-s-gray-700 dark:border-[#2D8C14] dark:placeholder-gray-400 dark:text-white" placeholder="Search" required />
...
<br/>
<div>
  <div className="grid grid-cols-1 gap-6 px-8 lg:grid-cols-4 ">
                    ...
                    <div className=" absolute -bottom-10 group-hover:top-0 left-0 w-full h-full group-hover:bg-green-900 transition-all ease-in-out duration-500  ">
                        <div className="w-full h-full   p-5   relative">
                            <div className="absolute bottom-0 group-hover:bottom-24 text-white  text-left   transition-all ease-in-out duration-500 ">
                                <h2 className="mb-2 text-10 font-bold pl-3 pt-1">Batik Mega Mendung</h2>
        ...
        <div className="grid grid-cols-1 gap-6 px-8 lg:grid-cols-4 ">
            ...
            <a href="#" className=" shadow-2xl relative ">
                <div className="  h-full relative shadow-2xl shadow-green-900 overflow-hidden group ">
                    <div className=" absolute -bottom-10 group-hover:top-0 left-0 w-full h-full group-hover:bg-green-900 transition-all ease-in-out duration-500  ">
                        <div className="w-full h-full   p-5   relative">
                            <div className="absolute bottom-0 group-hover:bottom-24 text-white  text-left   transition-all ease-in-out duration-500 ">
                                <h2 className="mb-2 text-10 font-bold pl-3 pt-1">Mangga Indonesia</h2>
                                <p className="mb-2 text-10 font-bold pl-3 pt-1">Lihat Selengkapnya</p>
                            </div>
                        </div>
                    </div>
            ...
            <a href="#" className=" shadow-2xl relative ">
                <div className="  h-full relative shadow-2xl shadow-green-900 overflow-hidden group ">
                    ...
                    <img src={GambarTS} className="w-full z-0  h-full    object-fill example "></img>
                </div>
            </a>
        </div>
